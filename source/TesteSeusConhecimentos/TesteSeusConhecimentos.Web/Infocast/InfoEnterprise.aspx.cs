...
namespace TesteSeusConhecimentos.Web.Infocast
{
    public partial class InfoEnterprise : System.Web.UI.Page
    {
        ...
        {
            Enterprise enterprise = new Enterprise(idEnterprise,txtName.Text,txtStreetAdress.Text,txtCity.Text, txtState.Text, txtZipCode.Text, txtCorporateActivity.Text);
